    ...
    return (
        <nav className="flex justify-between items-center h-16
            ...
            <div className="pr-8 md:block hidden">
                <NavLink to="/history" className="p-4 hover:text-purple-400"><span className={location.pathname === "/history" ? " text-purple-500" : ""}>Match History</span></NavLink>
                <NavLink to="/participants" className="p-4 hover:text-purple-400"><span className={location.pathname === "/participants" ? " text-purple-500" : ""}>Participants</span></NavLink>
                {token ?
                    <>
